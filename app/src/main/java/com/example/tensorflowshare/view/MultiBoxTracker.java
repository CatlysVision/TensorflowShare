...
import com.example.tensorflowshare.classifier.Classifier;
import com.example.tensorflowshare.classifier.Recognition;
import com.example.tensorflowshare.classifier.TFLiteObjectDetection;
...
public class MultiBoxTracker {
    ...
    private void processResults(final List<Recognition> results) {
        ...
        for (final Recognition result : results) {
            ...
            Log.i("ymc_test", "Result! Frame: " + result.getLocation() + " mapped to screen:" + detectionScreenRect);

            screenRects.add(new Pair<>(result.getConfidence(), detectionScreenRect));

            if (detectionFrameRect.width() < MIN_SIZE || detectionFrameRect.height() < MIN_SIZE) {
                Log.i("ymc_test", "Degenerate rectangle! " + detectionFrameRect);
                continue;
            }
        ...
        if (rectsToTrack.isEmpty()) {
            Log.i("ymc_test", "Nothing to track, aborting.");
            return;
        }
